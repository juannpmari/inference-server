...
def plot_ttft_vs_input_length(data: dict, out_dir: str, stat: str = "mean", scatter: bool = True) -> str:
...
def main():
    ...
    results_dir = Path(__file__).resolve().parent.parent / "results" / args.dispatch_mode / "ttft_vs_input_length"
    input_path = args.input or str(results_dir / "ttft_vs_input_length.json")
    ...
    fpath = plot_ttft_vs_input_length(data, output_dir, stat=args.stat, scatter=not args.no_scatter)
    print(f"Saved: {fpath}")
